...
public class DropDownRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.listview_refresh_head, null);
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText("Latest:" + new Date().toLocaleString());
		changeHeaderViewByState();
	}
