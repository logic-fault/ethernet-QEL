/******************************************************************************
  ...
  mTouchCapApp_2ChanDirectKeys.h (Header File)

Description:
    This file contains function prototypes that are used in DirectKeys.h
*******************************************************************************/

/*******************************************************************************
* FileName:        DirectKeys.h
...
*******************************************************************************/
#ifndef __MTOUCH_CAP_APP_2CHAN_DIRECTKEYS_H     //changed
#define __MTOUCH_CAP_APP_2CHAN_DIRECTKEYS_H

void   mTouchCapApp_2ChanDirectKeys_Create(void);
UINT16 mTouchCapApp_2ChanDirectKeys_Demo(void);

#endif      //end of #ifndef __MTOUCH_CAP_APP_2CHAN_DIRECTKEYS_H
